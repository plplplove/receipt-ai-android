...
private val LightColorScheme = lightColorScheme(
    ...
    surface = ReceiptAISurface,
    onPrimary = ReceiptAISurface,
    onSecondary = ReceiptAIPrimaryText,
    onTertiary = ReceiptAISurface,
    onBackground = ReceiptAIPrimaryText,
    onSurface = ReceiptAIPrimaryText
)
